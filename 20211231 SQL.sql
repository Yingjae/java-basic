...
-- PRIMARY KEY(주요키)
-- 각 테이블을 대표할 수 있는 대표데이터를 저장하는 컬럼에 붙이는 제약조건 입니다.
...
-- AUTO_INCREMENT(자동증가)
-- INT(정수)자료형이 붙은 컬럼에만 붙일 수 있고,
-- 이게 붙은 컬럼은 자동으로 1씩 증가하는 숫자를 배정받습니다.
-- 시작은 1입니다.
...
-- 참조컬럼에 있는 값만 buyTbl의 user_id에 올 수 있습니다.
--              ㄴ(userTbl의 user_id에 존재하는 값만)
CREATE TABLE buyTbl(
...
-- 회원부터 집어넣었음.
INSERT INTO userTbl VALUES('YJW', '임재원', 1996, '서울', '01011112222', 183, '2020-03-05');
INSERT INTO userTbl VALUES('SHM', '손흥민', 1992, '춘천', '01011113333', 183, '2020-03-05');
INSERT INTO userTbl VALUES('EM', '일론 머스크', 1971, '남아공', '01022223333', 188, '2020-03-05');
SELECT * FROM userTbl;

-- 가입한 회원이 물건을 산 이력이 남도록 하겠습니다.
INSERT INTO buyTbl VALUES(null, 'YJW', '기계식키보드', '주변기기', 200000, 1);
-- order_number는 값을 null로 주면 AUTO_INCREMENT에 의해 자동으로 1씩 증가된 숫자를 배정받음
INSERT INTO buyTbl VALUES(null, 'YJW', '듀얼모니터', '주변기기', 20000, 1);
-- 없는 회원을 이용해서 INSERT를 시도해보겠습니다.
