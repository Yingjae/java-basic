...
public class Asean {
	// 출석(check), 중간고사(midTerm), 기말고사(finaTerm)을 변수로 설정해주세요
	// 위 변수들은 개별 객체가 따로따로 관리하는 변수들입니다.
	private int check;
	private int midTerm;
	private int finalTerm;
	
	// 공용 발표점수인 presentationScore를 static으로 만들어 주세요.
	// 이 점수는 19점 입니다.
	...
	// 생성자는 객체 생성시 출석, 중간고사, 기말고사 점수만 받아서 초기화 합니다.
	...
	public void showAseanInfo() {
		...
		System.out.println("발표 : " + presentationScore + "점, 중간고사 : " + midTerm + "점, 기말고사 : " 
	+ finalTerm + "점, 출결 : " + check + "점");
	}
