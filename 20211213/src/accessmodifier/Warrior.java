...
public class Warrior {// 정의부. 실제 실행은 Main에서 할 예정임.
	...
	// 선언
	// 변수값은 현실에서도 특정한 물체나 사람의 살태가 휙휙 바뀌지 않으므로
	...
	// 체력 20, 마나10, 레벨1, 공격력 3, 방어력0, 경험치0이 대입되도록 처리해주세요.
	...
	public Warrior(String n) {
		...
		System.out.println("아이디 : " + n + "레벨 : " + lv);
	}
	...
	public void hunt() {
		hp -= 2;
		exp += 10;
		System.out.println("현재 체력이 " + hp + " 이(가) 되었고, 누적 경험치는 " + exp + " 입니다.");
	}
}
